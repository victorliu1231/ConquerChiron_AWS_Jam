...
namespace MEET_AND_TALK
{
    public class DialogueManager : DialogueGetData
    {
        ...
        private BaseNodeData currentNodeData;
        ...
        private void Update()
        {
            Timer -= CutsceneUtil.Instance.isSpedUp ? Time.deltaTime * CutsceneUtil.Instance.speedMultiplier : Time.deltaTime;
